...
<?php echo $_SESSION['cust_id'] ?> </label></label>
 ...
 <div class=container>
            ...
            <select name="branch">
                    <option value="Nashik" <?php if ($branch == 'Nashik') {?> selected="selected" <?php }?>>Nashik</option>
  
                  <option value="Pune" <?php if ($branch == 'Pune') {?> selected="selected" <?php }?>>Pune</option>
                 
   <option value="Chinchwad" <?php if ($branch == 'Chinchwad') {?> selected="selected" <?php }?>>Chinchwad</option>
                  
  <option value="Talegaon" <?php if ($branch == 'Talegaon') {?> selected="selected" <?php }?>>Talegaon</option>
                   
 <option value="Pimpari" <?php if ($branch == 'Pimpari') {?> selected="selected" <?php }?>>Pimpari</option>
                </select>
